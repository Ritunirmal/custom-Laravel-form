        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.basic.details.form.field.dependent.edit.save') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="DependentFieldId" aria-label="Default select example">
                                    ...
                                    @foreach($field as $item)
                                    <option value="{{$item->id}}" @if($data->dependent_field_id == $item->id) selected @endif>{{$item->label}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="FieldOptionId" aria-label="Default select example">
                                    ...
                                    <option value="{{$item->id}}"  @if($data->option_id == $item->id) selected @endif>({{$item->basicDetail->label}}) - {{$item->value}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="DependentFieldOptionId"
                                    ...
                                    @foreach($fieldoptions as $item)
                                    <option value="{{$item->id}}" @if($data->dependent_option_id == $item->id) selected @endif>({{$item->basicDetail->label}}) - {{$item->value}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check">
                                    <input name="show_hide"class="form-check-input" type="checkbox" id="gridCheck1"  @if($data->show_options == 1) checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check">
                                    <input name="disabled" class="form-check-input" type="checkbox" id="gridCheck2"  @if($data->disable_field == 1) checked @endif>
