...
<section class="section">
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Add Basic Details Dependent Field Options</h5>
                    <form action="{{ route('admin.basic.details.form.field.dependent.save') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="FieldOptionId" aria-label="Default select example">
                                    ...
                                    <option value="{{$item->id}}">({{$item->basicDetail->label}}) - {{$item->value}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
