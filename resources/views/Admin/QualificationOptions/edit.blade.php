        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.qualification.options.update') }}" method="post"
                        ...
                        @endif
                        <input type="hidden" class="form-control" name="qualification[]" value="{{$data->id}}">
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Qualification</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="qualificationame[]" value="{{$data->name}}"
                                    readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                                ...
                                @foreach($formField as $option)
                                    <div class="input-group mb-3 option">
                                        ...
                                        <input type="text" class="form-control" name="option_value[]"
                                            value="{{ $option->option }}" placeholder="Enter option">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('admin.qualification.options') }}" class="btn btn-secondary">Cancel</a>
                        </div>
