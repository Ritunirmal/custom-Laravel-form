...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <a href="{{ route('admin.home.content.create') }}" class="btn btn-primary">Add Home Content</a>
            </div>
            <table id="form-content-note" class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Note</th>
...
$(document).ready(function() {
    var table1 = $('#form-content-note').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.home.content') }}",
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#form-content-note').on('change', '.show-option-toggle', function() {
        ...
        $.ajax({
            url: '{{ route('admin.home.content.toggle') }}',
